...
//       <div
//         className={`rounded-lg bg-gradient-to-r ${gradient} p-0.5 shadow-lg`}
//       >
//         {/* Inner Content with Solid Background */}
//         <div className="tab rounded-lg bg-gray-800 overflow-hidden">
//           {/* Accordion Header */}
//           <div
...
//               padding: open ? "1rem 1.5rem" : "0", // Only apply padding when open
//             }}
//           >
//             {/* Text Content */}
//             {open && (
...
//                   <span
//                     key={skillIndex}
//                     className={`bg-blue-500 ${theme.text} text-sm px-3 py-1 rounded-full`}
//                   >
//                     {skill}
//                   </span>
//                 ))}
